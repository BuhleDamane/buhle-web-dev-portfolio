...
Through my SheCodes journey, I've worked through these certifications, each one building on the last:

| Certificate | Completed | What I Covered |
|---|---|---|
| Introduction to Coding | 2023 | HTML, CSS, JavaScript basics — my first real introduction to building for the web |
| Web Development | 2024 | Vanilla JavaScript, working with APIs, Git workflows |
| Responsive Web Development | 2024 | Bootstrap, Flexbox, Grid, SEO — making things work on any screen |
| React Development | 2024 | React.js, Hooks, state management — finally understanding component-based architecture |
| Introduction to AI | 2025 | AI integration, working with APIs, prompt engineering |
...
I'm looking for roles in web development, frontend development, full-stack development (especially with Firebase), or anything that lets me build things people actually use. I'm based in South Africa, open to remote work, contracts, part-time, or full-time positions.
